...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Question.text_answer'
        db.add_column('main_question', 'text_answer', self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Question.text_answer'
        db.delete_column('main_question', 'text_answer')
