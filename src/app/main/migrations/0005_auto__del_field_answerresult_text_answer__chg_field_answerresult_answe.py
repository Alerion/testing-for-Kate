...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AnswerResult.text_answer'
        db.delete_column('main_answerresult', 'text_answer')

        # Changing field 'AnswerResult.answer'
        db.alter_column('main_answerresult', 'answer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Answer']))

        # Adding field 'AnswerChoice.text_answer'
        db.add_column('main_answerchoice', 'text_answer', self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'AnswerResult.text_answer'
        db.add_column('main_answerresult', 'text_answer', self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True), keep_default=False)

        # Changing field 'AnswerResult.answer'
        db.alter_column('main_answerresult', 'answer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Answer'], null=True))

        # Deleting field 'AnswerChoice.text_answer'
        db.delete_column('main_answerchoice', 'text_answer')
